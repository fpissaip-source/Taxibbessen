    ...
    <Layout>
      <div>
        ...
        <section id="leistungen" ref={servicesRef} className="py-24 lg:py-32 relative" style={{ zIndex: 2 }}>
          ...
          <div className="absolute inset-0 pointer-events-none" style={{ background: "linear-gradient(to bottom, hsl(220,20%,4%) 0%, rgba(8,10,16,0.42) 22%, rgba(8,10,16,0.42) 78%, rgba(8,10,16,0.12) 100%)" }} />

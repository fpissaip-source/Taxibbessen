    ...
    <Layout>
      <div>
        ...
        <section id="leistungen" ref={servicesRef} className="py-24 lg:py-32 relative" style={{ zIndex: 2 }}>
          ...
          <div className="absolute top-0 left-0 right-0 pointer-events-none" style={{ height: "70vh", background: "linear-gradient(to bottom, transparent 0%, hsl(220,20%,4%) 8%, hsl(220,20%,4%) 13%, transparent 22%, transparent 100%)" }} />
